...
// créer un donateur
	...
	public void testCreateDonateur() {
		Donateur donateur;
		donateur = new Donateur(null, "Istam", "Julie", "julie@gg.com", "Turquie", 3000.00, Devise.Livre_Turque);
	...
	{
		List<Donateur> donateurs = donateurRepository.findByNom("lounadi");
		for (Donateur donateur: donateurs)
		{
			System.out.println(donateur);
		}
	...
	{
		List<Donateur> donateurs = donateurRepository.findAllByNomContainingIgnoreCase("o");
		for (Donateur donateur: donateurs)
		{
			System.out.println(donateur);
		}
